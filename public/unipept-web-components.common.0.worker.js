...
/******/ 	return __webpack_require__(__webpack_require__.s = "2f02");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var core_js_modules_es7_symbol_async_iterator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("ac4d");
/* harmony import */ var core_js_modules_es7_symbol_async_iterator__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es7_symbol_async_iterator__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var core_js_modules_es6_symbol__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("8a81");
...
/* harmony import */ var threads__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("501f");
...
Object(threads__WEBPACK_IMPORTED_MODULE_8__[/* expose */ "a"])(process);
/**
...
function process(peptides, searchConfiguration) {
  var start = new Date().getTime();
  peptides = filter(peptides, searchConfiguration);
  var peptideCounts = new Map();
  var processed = 0;
  ...
  try {
    for (var _iterator = peptides[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var peptide = _step.value;
      processed++;
      var count = peptideCounts.get(peptide) || 0;
  ...
  try {
    for (var _iterator2 = peptideCounts.values()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
function filter(peptides, searchConfiguration) {
  var out = cleavePeptides(peptides, searchConfiguration.enableMissingCleavageHandling);
...
function cleavePeptides(peptides, advancedMissedCleavageHandling) {
  ...
  if (!advancedMissedCleavageHandling) {
    ...
    // }
    // return output;
    return peptides.join("+").replace(/([KR])([^P])/g, "$1+$2").replace(/([KR])([^P+])/g, "$1+$2").split("+");
  }
...
function equateIL(peptides, equateIL) {
  if (equateIL) {
    return peptides.map(function (p) {
      return p.replace(/I/g, "L");
    });
  }
...
/******/ });
//# sourceMappingURL=unipept-web-components.common.0.worker.js.map