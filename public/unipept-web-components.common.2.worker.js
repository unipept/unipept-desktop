...
/******/ 	return __webpack_require__(__webpack_require__.s = "bf30");
/******/ })
/************************************************************************/
/******/ ({
...
// CONCATENATED MODULE: ./src/business/ontology/taxonomic/ncbi/NcbiTaxon.ts


var NcbiTaxon_NcbiTaxon = function NcbiTaxon(id, name, rank, lineage) {
  _classCallCheck(this, NcbiTaxon);
...
// CONCATENATED MODULE: ./node_modules/@vue/cli-plugin-babel/node_modules/cache-loader/dist/cjs.js??ref--14-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/ts-loader??ref--14-3!./node_modules/eslint-loader??ref--13-0!./src/business/ontology/taxonomic/ncbi/NcbiOntologyProcessor.worker.ts
...
function process(ids, responseMap) {
  ...
  try {
    for (var _iterator = ids[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var id = _step.value;
      var apiResponse = responseMap.get(id);

      if (apiResponse) {
        definitions.set(id, new NcbiTaxon_NcbiTaxon(apiResponse.id, apiResponse.name, apiResponse.rank, apiResponse.lineage));
        var _iteratorNormalCompletion2 = true;
        var _didIteratorError2 = false;
        var _iteratorError2 = undefined;

        try {
          for (var _iterator2 = apiResponse.lineage.filter(function (t) {
            return t !== null && t !== -1;
          })[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            var lineageId = _step2.value;
            lineageId = Math.abs(lineageId);

            var _apiResponse = responseMap.get(lineageId);

            if (_apiResponse) {
              definitions.set(lineageId, new NcbiTaxon_NcbiTaxon(_apiResponse.id, _apiResponse.name, _apiResponse.rank, _apiResponse.lineage));
            }
          }
        } catch (err) {
...
/******/ });
//# sourceMappingURL=unipept-web-components.common.2.worker.js.map