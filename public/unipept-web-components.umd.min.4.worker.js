...
/******/ 	return __webpack_require__(__webpack_require__.s = "a595");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return computeTree; });
...
/* harmony import */ var threads__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("501f");
...
Object(threads__WEBPACK_IMPORTED_MODULE_3__[/* expose */ "a"])({
  computeTree: computeTree
});
function computeTree(peptides, tree, taxaToPeptidesMapping) {
  return callRecursivelyPostOrder(tree.root, function (t, c) {
    var included = c.some(function (x) {
      return x.included;
    }) || taxaToPeptidesMapping.has(t.id) && taxaToPeptidesMapping.get(t.id).some(function (pept) {
      return peptides.includes(pept);
    });
...
function callRecursivelyPostOrder(node, f) {
  var childResults = [];

  if (node.children) {
    childResults = node.children.map(function (c) {
      return callRecursivelyPostOrder(c, f);
    });
  }
...
/******/ });
//# sourceMappingURL=unipept-web-components.umd.min.4.worker.js.map